import illustrationThakYou from '../assets/illustration-thank-you.svg'

export function CardFinal(props){
    return(
        <div className='bg-gradient-dark text-white mx-6 p-6 rounded-2xl font-overpass max-w-103'>

        <img className='mx-auto mb-6' src={illustrationThakYou} alt="Illustration Thak You" />

        <p className='text-orange bg-dark-blue w-fit mx-auto px-3 py-1.25 rounded-3xl mb-6'>You selected {props.notaAvaliacao} out of 5</p>
